---
title: You Computer Geeks Are All The Same
authors:
  - name: louiechristie
...
metadata:
  ...
  tags:
    ...
    - Time management
  media:
    featuredImage: assets/d8aa71ab-63ec-43d5-9c04-c6a20c-2XCsMBKRKKXW.jpeg
  featuredImage: >-
    https://louiechristie.wordpress.com/wp-content/uploads/2021/02/d8aa71ab-63ec-43d5-9c04-c6a20cff7044_1_105_c.jpeg
  uuid: 11ty/import::wordpressapi-hosted::http://blog.local/?p=2191
  type: wordpressapi-hosted
  url: >-
    https://louiechristie.wordpress.com/2021/02/19/you-computer-geeks-are-all-the-same/
---
...
-   [Good cop version](#good-cop-version)
-   [Bad cop version](#bad-cop-version)
-   Stick with this the [rant version](#rant-version)
...
Another term for it is ‘executive function’. I learned that from the Viking coder.
...
(With the noticeable exception of the recent [Universal Credit website](https://www.bbc.co.uk/iplayer/episode/m000f1xd/sign/universal-credit-inside-the-welfare-state-series-1-episode-1#t=13m08s) which during the pandemic dealt rather well with an extra 1 million unemployment claims \[thanks scalable tech\] unlike the USA [COBOL cowboy](https://en.wikipedia.org/wiki/COBOL_Cowboys) systems.

\[Advert\]

What the hell, I’ll get my spurs, gun, and [COBOL](https://www.youtube.com/watch?v=7d7-etf-wNI) badge out of retirement…

[I’m available for COBOL IBM 1970’s mainframe pandemic work](https://community.openmainframeproject.org/t/modern-web-developer-rusty-in-cobol-happy-to-help-in-covid-19/4760)  
(or legacy 1960’s mainframes)

\[Advert End\]

(OK, the UK Universal Credit system _did_ make the headlines when first released. But the problems, as always, weren’t with the tech, but the decisions in the heads of the people behind it.)

Perhaps knowing when to lose interest in a project is our, the geeks’, evolutionary advantage.

So we don’t waste our precious life force on the latest misguided slow train wreck project trying to [put magazine printing press 14 inch typesetting on 4 inch phones](https://css-tricks.com/print-design-to-web-design/) that can’t be read by the blind or fed-up commuter.
...
And I suppose, like in the [Alcoholics Anonymous saying](https://en.wikipedia.org/wiki/Serenity_Prayer#Precursors), the serenity secret that separates the guy who’s still building a clockwork abacus in his shed, and [Bill Gates building a vaccine factory](https://www.ted.com/talks/bill_gates_the_next_outbreak_we_re_not_ready?language=en) robot, is knowing the difference between which tech project to drop, and which to finish.
...
P.S. [Check out this advice from author Neil Strauss](https://www.neilstrauss.com/advice/the-attention-management-plan/). He’s recently been writing about how to write a book but the advice equally applies to any creative project.

Update 2023: in the wake of Heroku charging for side projects: RIP sharespots.co.uk – sometimes a project isn’t worth maintaining.

* * *

\[Advert\]

I’m available for coaching, consultancy, coding, [hosting tech events](https://comedy.louiechristie.com/tech-event-host/), writing, etc.

You can [contact me here](https://www.louiechristie.com/blog/contact/)

I’m also available through [the Future Strategy club for consultancy (UK/Worldwide)](https://www.futurestrategy.club/contact) or through [G2i for React Native / React coding (USA/Worldwide)](https://www.g2i.co/about-us).

{End of Advert\]

## You may also be interested in:

[Dear Alvin Part One: If you were to start React all over again what would you do? \[NSFW\]](https://www.louiechristie.com/blog/2018/11/30/if-you-were-to-start-react-all-over-again-what-would-you-do/)