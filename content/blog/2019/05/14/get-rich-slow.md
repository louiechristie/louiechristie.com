---
title: Get rich slow and win at universal credit with tech
authors:
  - name: louiechristie
...
metadata:
  ...
  tags:
    ...
    - tech for good
  media:
    featuredImage: assets/img_3065-1-e1557920194167-PcHmWC4SMGId.jpg
  featuredImage: >-
    https://louiechristie.wordpress.com/wp-content/uploads/2019/05/img_3065-1-e1557920194167.jpg
  uuid: 11ty/import::wordpressapi-hosted::http://blog.louiechristie.com/?p=865
  type: wordpressapi-hosted
  url: https://louiechristie.wordpress.com/2019/05/14/get-rich-slow/
---
...
Recently, I read a [blog post](https://jwong.co.uk/blog/2019/03/15/i-hate-finances//) from Jenny Wong[\[2\]](./#2) about turning around her finances. It reminded me of the book [‘The Barefoot Investor: The only money guide you’ll ever need’](https://barefootinvestor.com/books/). My brother in Australia recommended it to me – it’s a best selling sensation over there apparently.
...
Actually, The Barefoot Investor recommends a lot of the things you suggest Jenny – it’s almost as if you’d read the book. But it sounds like you came up with the same ideas independently – which is a good sign. That happens in nature too, and its called convergent evolution. It’s the reason our [British Fox has a similar skull to the unrelated Australian Tasmanian Devil](https://en.wikipedia.org/wiki/Convergent_evolution#Bodyplans).

Recently, I’ve been playing around with [Actual Budget](http:// https://actualbudget.com/) software for budgeting.[\[3\]](./#3)

It was in Alpha stage when I started, and missing a lot of features, but it was good (and free) for making a simple budget. And the author of the software previously made [Prettier](https://github.com/prettier/prettier) – so he has enough credibility to take notice.

So many pieces of technology make the claim that they will make you, the software developer, 10x (ten times) more productive. They never do, normally you end up fighting with the tool to do what you want. [Prettier](https://github.com/prettier/prettier) actually did make me, I think, 10-20% more productive, which is a decent productivity gain.

I’ve been influenced by a [TED talk I saw by Hilary Cottam](https://www.peckhamlevels.org/member/hilary-cottam) about a new approach to welfare benefits. (I discovered Cottam’s website while investigating a hipster co-working space, and disused multi-story car park, [Peckham Levels](https://www.peckhamlevels.org/about) in South London, near me.) Also I’ve been touched by personal stories related to the introduction, by the UK government, of the new [Universal Credit](https://www.gov.uk/universal-credit) welfare state benefits scheme. I’m not going to get into politics here, but a lot of people on [Universal Credit](https://www.gov.uk/universal-credit) are having money problems because the scheme requires them to do monthly budgeting, something they previously didn’t need to do when their rent was paid automatically to the council, and they got money fortnightly.
...
-   The [Barefoot Investor](https://barefootinvestor.com/books/)‘s advice
-   Wisdom of the UK finance landscape[\[4\]](./#4)
-   [Actual Budget](https://actualbudget.com/)
-   [Monzo Pots or Automated bank transfers possibly using IFTTT.com](https://community.monzo.com/t/idea-pay-a-percentage-of-every-income-payment-into-a-pot-useful-for-freelancers-gig-workers-saving/113542)
-   [Open Banking protocols](https://en.wikipedia.org/wiki/Open_banking)

Don’t know what bureaucratic structure would make most sense for the project to take: not-for-profit, for-profit, company, charity, government project, or, whatever works to _help people_. But I reckon it could potentially get a lot of poor people out of poverty.

Anyone reading this agree and want to help make it happen? Then [get in touch with me](https://blog.louiechristie.com/contact/).

[Louie Christie](https://www.louiechristie.com/)

## Footnotes

\[1\] Page 17, [The Barefoot Investor: The only money guide you’ll ever need](https://barefootinvestor.com/books/).
...
\[3\] After getting made redundant from one of those failed technology start-up companies you hear about in the footnotes of the technology news (_update 2018: it didn’t even make the footnotes_), I suddenly got interested in budgeting. Interesting, unexpected insights. I thought I’d end up cancelling things like my Netflix subscription or Amazon Prime to save money. Nope. Looking at the Actual Budget data, I discovered going out, and eating out, were my biggest lines of expendable income I could save on. By staying in, and watching Netflix for a few pounds a month, I was saving money over drinking beer in London pubs for a few pounds a half-hour. Learning to cook, and eating cheaply, would be my biggest saver. More on that in a future blog post. Or get the book [\[Ad\] The Urban Hermit by Samuel A. MacDonald \[End of Ad\]](http://www.amazon.com/dp/0312429150/?tag=louiechristie-21) from your local library (ISBN-10: 0312429150), that’s what I did last time I was broke.

\[4\] I used to volunteer at a rough inner-city youth club in Brixton, South London, for the now defunct Kids Company (_update 2021: now exonerated._) Thought I’d end up coaching skateboarding or computer coding. Nope. I like to be lead by the young people’s interests. Turns out inner-city kids from poor backgrounds are most interested in… GETTING RICH. Makes sense when you think about it. Ended up giving seminars about ISAs and pension plans to a [hoodie](https://www.urbandictionary.com/define.php?term=hoodie). But that’s a topic for another blog post.
